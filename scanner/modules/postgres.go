...
// PostgresChecker is an implementation of CommandChecker for PostgreSQL service
func PostgresChecker(target net.IP, port int, timeout time.Duration, dialer *utils.ProxyAwareDialer, defaultUsername, defaultPassword string) (bool, bool, error) {
	var err error
...
func GetPostgresConnection(target net.IP, port int, encryption bool, d *utils.ProxyAwareDialer, username, password string) (*sql.DB, error) {
